...
/obj/item/clothing/gloves/roguetown/leather
	...
	desc = "Кожаные перчатки, которые обычно носят рабочие, чтобы защитить пальцы от травм."
...
/obj/item/clothing/gloves/roguetown/leather/black
	desc = "Кожаные перчатки, которые обычно носят рабочие. Выкрашены в черный цвет."
	color = "#6b6c6b"
	icon_state = "gloves_black"

/obj/item/clothing/gloves/roguetown/leather/advanced
	name = "крепкие кожаные перчатки"
...
/obj/item/clothing/gloves/roguetown/leather/masterwork
	...
	desc = "Эти перчатки — чудо мастерства. Сделаны из лучшей кожи, потому они прочные, легкие и надежные."
...
/obj/item/clothing/gloves/roguetown/leather/angle
	...
	desc = "Пара перчаток из уплотненных шкур и меха."
	icon_state = "angle"
