...
/obj/effect/proc_holder/spell/invoked/abyssheal/cast(list/targets, mob/living/user)
	...
	if(isliving(targets[1]))
		...
		var/list/water = list(/turf/open/water/bath, /turf/open/water/cleanshallow, /turf/open/water/swamp, /turf/open/water/swamp/deep, /turf/open/water/river)
		situational_bonus = 0
