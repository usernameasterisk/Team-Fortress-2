...
/datum/statpack/wildcard/wretched
	name = "Обездоленный"
	desc = "Остров Энигма есть настоящим скоплением разнообразных отбросов общества и вы - не исключение. Может быть, хотя бы на этот раз вам повезёт?"
...
/datum/statpack/wildcard/fated
	name = "Обречённый"
	desc = "Ты обречён. Но вот на поражение ли, либо на победу, - покажет судьба."
...
/datum/statpack/wildcard/frail
	name = "Жалкий"
	desc = "С каждым днём тебе всё хуже и хуже, будто бы сами боги отвернулись от тебя... Как же ты планируешь пережить очередную неделю, да ещё и в таких условиях?"
